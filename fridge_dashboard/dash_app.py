...
app.layout = html.Div([
    ...
    dcc.Tabs(
        ...
        children=[
            ...
            dcc.Tab(label="📝 Notes", value="notes-tab", className="main-tab"),
        ]
    ),
...
def create_notes_tab_content():
    """Create the content for the Notes tab."""
    current_content = db.get_note()
    return html.Div(
        className="notes-container",
        children=[
            html.Div(
